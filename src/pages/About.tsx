...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Talkigen - AI Chatbot Platform Founded by Yahya Hanif</title>
        <meta name="description" content="Learn about Talkigen's mission to democratize AI-powered customer service. Founded by Yahya Hanif to make intelligent chatbots accessible to businesses of all sizes." />
        <meta name="keywords" content="about talkigen, yahya hanif, AI chatbot company, chatbot platform founder, conversational AI startup" />
        <link rel="canonical" href="https://talkigen.com/about" />
        
        <meta property="og:title" content="About Talkigen - AI Chatbot Platform Founded by Yahya Hanif" />
        <meta property="og:description" content="Learn about Talkigen's mission to democratize AI-powered customer service. Founded by Yahya Hanif to make intelligent chatbots accessible to businesses of all sizes." />
        <meta property="og:url" content="https://talkigen.com/about" />
        <meta property="og:type" content="website" />
        
        <meta name="twitter:title" content="About Talkigen - AI Chatbot Platform Founded by Yahya Hanif" />
        <meta name="twitter:description" content="Learn about Talkigen's mission to democratize AI-powered customer service. Founded by Yahya Hanif to make intelligent chatbots accessible to businesses of all sizes." />
        ...
        {JSON.stringify({
          ...
          "mainEntity": {
            ...
            "founder": {
              ...
              "sameAs": "https://www.linkedin.com/in/yahyahanif/"
            },
            "foundingDate": "2024",
            "url": "https://talkigen.com",
            "sameAs": [
              "https://twitter.com/talkigen",
              "https://linkedin.com/company/talkigen"
            ]
          }
        })}
        </script>
